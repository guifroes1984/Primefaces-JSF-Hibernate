...
public class LazyDataTableModelUserPessoa<T> extends LazyDataModel<UsuarioPessoa> {/*Aqui dentro vai consultar o SQL no BD de acordo com a página que está sendo pedida*/
